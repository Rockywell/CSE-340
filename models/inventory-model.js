...
/* ***************************
 *  Get the inventory item details and item_name by inventory_id
 * ************************** */
...
/* *****************************
*   Register new item/vehicle/inventory
* *************************** */
...
async function checkExistingClassification(classification_name) {
    try {
        ...
        return classification.rowCount >= 1
    } catch (error) {
        return error.message
    }
}
...
module.exports = { getClassifications, getInventoryByClassificationId, getItemByInventoryId, registerClassification, registerInventory, checkExistingClassification };